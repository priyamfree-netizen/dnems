...
class CourseCategoryDropdown extends StatefulWidget {
  ...
  final bool border;
  final String title;
  final List<CourseCategoryItem>? items ;
  final Function(CourseCategoryItem?)? onChanged;
  final CourseCategoryItem? selectedValue;
  const CourseCategoryDropdown({super.key, this.width, this.border = false, required this.title, this.items, this.onChanged, this.selectedValue});

  @override
  State<CourseCategoryDropdown> createState() => _CourseCategoryDropdownState();
}
...
class _CourseCategoryDropdownState extends State<CourseCategoryDropdown> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(decoration: BoxDecoration(
      ...
      child: DropdownButton2<CourseCategoryItem>(
        isExpanded: true,
        isDense: true,
        ...
        widget.items?.map((CourseCategoryItem item) => DropdownMenuItem<CourseCategoryItem>(
