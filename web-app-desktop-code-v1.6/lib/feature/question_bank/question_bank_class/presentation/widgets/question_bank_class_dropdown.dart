...
class QuestionBankClassDropdown extends StatefulWidget {
  final double? width;
  final bool border;
  final String title;
  final List<QuestionBankClassItem>? items ;
  final Function(QuestionBankClassItem?)? onChanged;
  final QuestionBankClassItem? selectedValue;
  const QuestionBankClassDropdown({super.key, this.width, this.border = false, required this.title, this.items, this.onChanged, this.selectedValue});

  @override
  State<QuestionBankClassDropdown> createState() => _QuestionBankClassDropdownState();
}

class _QuestionBankClassDropdownState extends State<QuestionBankClassDropdown> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(decoration: BoxDecoration(
      ...
      child: DropdownButton2<QuestionBankClassItem>(
        isExpanded: true,
        ...
        widget.items?.map((QuestionBankClassItem item) => DropdownMenuItem<QuestionBankClassItem>(
