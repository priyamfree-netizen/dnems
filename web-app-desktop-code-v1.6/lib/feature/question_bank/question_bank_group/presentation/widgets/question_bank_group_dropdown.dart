...
class QuestionBankGroupDropdown extends StatefulWidget {
  final double? width;
  final bool border;
  final String title;
  final List<QuestionBankGroupItem>? items ;
  final Function(QuestionBankGroupItem?)? onChanged;
  final QuestionBankGroupItem? selectedValue;
  const QuestionBankGroupDropdown({super.key, this.width, this.border = false, required this.title, this.items, this.onChanged, this.selectedValue});

  @override
  State<QuestionBankGroupDropdown> createState() => _QuestionBankGroupDropdownState();
}

class _QuestionBankGroupDropdownState extends State<QuestionBankGroupDropdown> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(decoration: BoxDecoration(
      ...
      child: DropdownButton2<QuestionBankGroupItem>(
        isExpanded: true,
        ...
        widget.items?.map((QuestionBankGroupItem item) => DropdownMenuItem<QuestionBankGroupItem>(
