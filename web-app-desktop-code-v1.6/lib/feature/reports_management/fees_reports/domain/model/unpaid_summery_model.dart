...
class UnPaidSummeryModel {
  ...
  UnPaidSummeryModel.fromJson(Map<String, dynamic> json) {
    ...
    data = json['data'] != null ? UnpaidSummery.fromJson(json['data']) : null;
...
class UnpaidSummery {
  ...
  UnpaidSummery({this.sessionId, this.classId, this.sectionId, this.studentData});
...
class StudentData {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (feeHeads != null) {
      data['feeHeads'] = feeHeads!.map((v) => v.toJson()).toList();
    }
...
class Amount {
  ...
  Amount.fromJson(Map<String, dynamic> json) {
    ...
    foundFeeAmount = PriceConverter.parseAmount(json['found_fee_amount']);
  }
