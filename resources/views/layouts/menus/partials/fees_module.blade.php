@if (
    $user->can('fees_management.startup') ||
        $user->can('fees_management.mapping') ||
        $user->can('fees_management.amount_config') ||
        $user->can('fees_management.date_config') ||
        $user->can('fees_management.fine_waiver') ||
        $user->can('fees_management.waiver') ||
        $user->can('fees_management.waiver_config') ||
        $user->can('fees_management.smart_collection') ||
        $user->can('fees_management.paid_info') ||
        $user->can('fees_management.unpaid_info'))

    <!--begin:Menu item-->
    <div data-kt-menu-trigger="click"
        class="menu-item menu-accordion {{ Request::is('fee-head') ||
        ...
        <span class="menu-link">
            ...
            <span class="menu-title">{{ _lang('Fees Management') }}</span>
        ...
        <div class="menu-sub menu-sub-accordion">
            ...
            @if ($user->can('fees_management.startup'))
                <!--begin:Menu item-->
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ Route::is('fee-head.index') ? 'active' : '' }}"
                        href="{{ route('fee-head.index') }}">
                        <span class="menu-bullet">
                            <span class="bullet bullet-dot"></span>
                        </span>
                        <span class="menu-title">{{ _lang('Fees StartUp') }}</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
            ...
            @if ($user->can('fees_management.mapping'))
                <!--begin:Menu item-->
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ Route::is('fees-mapping.index') ? 'active' : '' }}"
                        href="{{ route('fees-mapping.index') }}">
                        <span class="menu-bullet">
                            <span class="bullet bullet-dot"></span>
                        </span>
                        <span class="menu-title">{{ _lang('Fees Mapping') }}</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
            ...
            @if ($user->can('fees_management.amount_config'))
                <!--begin:Menu item-->
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ Route::is('amount-config.index') ? 'active' : '' }}"
                        href="{{ route('amount-config.index') }}">
                        <span class="menu-bullet">
                            <span class="bullet bullet-dot"></span>
                        </span>
                        <span class="menu-title">{{ _lang('Amount Config') }}</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
            ...
            @if ($user->can('fees_management.date_config'))
                <!--begin:Menu item-->
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ Request::is('date-config') ? 'active' : '' }}"
                        href="{{ route('date-config.index') }}">
                        <span class="menu-bullet">
                            <span class="bullet bullet-dot"></span>
                        </span>
                        <span class="menu-title">{{ _lang('Date Config') }}</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
            ...
            @if ($user->can('fees_management.fine_waiver'))
                <!--begin:Menu item-->
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ Route::is('attendance-waiver.index') ? 'active' : '' }}"
                        href="{{ route('attendance-waiver.index') }}">
                        <span class="menu-bullet">
                            <span class="bullet bullet-dot"></span>
                        </span>
                        <span class="menu-title">{{ _lang('Fine Waiver') }}</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
            ...
            @if ($user->can('fees_management.waiver'))
                <!--begin:Menu item-->
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ Route::is('waivers.index') ? 'active' : '' }}"
                        href="{{ route('waivers.index') }}">
                        <span class="menu-bullet">
                            <span class="bullet bullet-dot"></span>
                        </span>
                        <span class="menu-title">{{ _lang('Waiver') }}</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
            ...
            @if ($user->can('fees_management.waiver_config'))
                <!--begin:Menu item-->
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ Route::is('waiver-config.index') ? 'active' : '' }}"
                        href="{{ route('waiver-config.index') }}">
                        <span class="menu-bullet">
                            <span class="bullet bullet-dot"></span>
                        </span>
                        <span class="menu-title">{{ _lang('Waiver Config') }}</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
            ...
            @if ($user->can('fees_management.smart_collection'))
                <!--begin:Menu item-->
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ Route::is('quick-collection.index') || Request::is('quick-collection/*') ? 'active' : '' }}"
                        href="{{ route('quick-collection.index') }}">
                        <span class="menu-bullet">
                            <span class="bullet bullet-dot"></span>
                        </span>
                        <span class="menu-title text-danger">{{ _lang('Smart Collection') }}</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
            ...
            @if ($user->can('fees_management.paid_info'))
                <!--begin:Menu item-->
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ Request::is('payment-fee-info') ? 'active' : '' }}"
                        href="{{ route('payment-fee-info') }}">
                        <span class="menu-bullet">
                            <span class="bullet bullet-dot"></span>
                        </span>
                        <span class="menu-title">{{ _lang('Paid Info') }}</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
            ...
            @if ($user->can('fees_management.unpaid_info'))
                <!--begin:Menu item-->
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ Request::is('unpaid-info') ? 'active' : '' }}"
                        href="{{ route('unpaid-info') }}">
                        <span class="menu-bullet">
                            <span class="bullet bullet-dot"></span>
                        </span>
                        <span class="menu-title">{{ _lang('Unpaid Info') }}</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
