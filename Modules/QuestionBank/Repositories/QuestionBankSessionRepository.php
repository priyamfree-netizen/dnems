...
use Modules\QuestionBank\Models\QuestionBankSession;
use Symfony\Component\HttpFoundation\Response;

class QuestionBankSessionRepository extends EntityRepository
{
    public string $table = QuestionBankSession::TABLE_NAME;
    ...
    private function getQuestionBankSessionQuery(): Builder
    {
    ...
    public function getAll(array $filterData = []): Paginator
    {
        ...
        $query = $this->getQuestionBankSessionQuery();
    ...
    public function create(array $data): object
    {
        ...
        return QuestionBankSession::find($id);
    }
    ...
    {
        $item = QuestionBankSession::findOrFail($id);
    ...
    {
        return [
            static::MESSAGE_ITEM_DOES_NOT_EXIST_MESSAGE => 'QuestionBankSession does not exist.',
            static::MESSAGE_ITEM_COULD_NOT_BE_DELETED => 'QuestionBankSession could not be deleted.',
        ];
    }
}
