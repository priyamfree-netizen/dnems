...
use Modules\QuestionBank\Models\QuestionBankTag;
use Symfony\Component\HttpFoundation\Response;

class QuestionBankTagRepository extends EntityRepository
{
    public string $table = QuestionBankTag::TABLE_NAME;
    ...
    private function getQuestionBankTagQuery(): Builder
    {
    ...
    protected function filterSearchQuery(Builder|EloquentBuilder $query, string $searchedText): Builder
    {
        ...
        return $query->where("{$this->table}.tag_name", 'LIKE', $searchable)
    ...
    public function getAll(array $filterData = []): Paginator
    {
        ...
        $query = $this->getQuestionBankTagQuery();
    ...
    {
        $item = $this->getQuestionBankTagQuery()
    ...
    public function create(array $data): object
    {
        ...
        return QuestionBankTag::find($id);
    }
    ...
    {
        $item = QuestionBankTag::findOrFail($id);
    ...
    {
        return [
            static::MESSAGE_ITEM_DOES_NOT_EXIST_MESSAGE => 'QuestionBankTag does not exist.',
            static::MESSAGE_ITEM_COULD_NOT_BE_DELETED => 'QuestionBankTag could not be deleted.',
        ];
    }
}
