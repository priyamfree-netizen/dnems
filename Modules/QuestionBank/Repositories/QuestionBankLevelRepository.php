...
use Modules\QuestionBank\Models\QuestionBankLevel;
use Symfony\Component\HttpFoundation\Response;

class QuestionBankLevelRepository extends EntityRepository
{
    public string $table = QuestionBankLevel::TABLE_NAME;
    ...
    private function getQuestionBankLevelQuery(): Builder
    {
    ...
    protected function filterSearchQuery(Builder|EloquentBuilder $query, string $searchedText): Builder
    {
        ...
        return $query->where("{$this->table}.level_name", 'LIKE', $searchable)
    ...
    public function getAll(array $filterData = []): Paginator
    {
        ...
        $query = $this->getQuestionBankLevelQuery();
    ...
    {
        $item = $this->getQuestionBankLevelQuery()
    ...
    public function create(array $data): object
    {
        ...
        return QuestionBankLevel::find($id);
    }
    ...
    {
        $item = QuestionBankLevel::findOrFail($id);
    ...
    {
        return [
            static::MESSAGE_ITEM_DOES_NOT_EXIST_MESSAGE => 'QuestionBankLevel does not exist.',
            static::MESSAGE_ITEM_COULD_NOT_BE_DELETED => 'QuestionBankLevel could not be deleted.',
        ];
    }
}
