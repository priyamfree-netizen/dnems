...
use Modules\QuestionBank\Models\QuestionBankBoard;
use Symfony\Component\HttpFoundation\Response;

class QuestionBankBoardRepository extends EntityRepository
{
    public string $table = QuestionBankBoard::TABLE_NAME;
    ...
    private function getQuestionBankBoardQuery(): Builder
    {
    ...
    protected function filterSearchQuery(Builder|EloquentBuilder $query, string $searchedText): Builder
    {
        ...
        return $query->where("{$this->table}.board", 'LIKE', $searchable)
    ...
    public function getAll(array $filterData = []): Paginator
    {
        ...
        $query = $this->getQuestionBankBoardQuery();
    ...
    {
        $item = $this->getQuestionBankBoardQuery()
    ...
    public function create(array $data): object
    {
        ...
        return QuestionBankBoard::find($id);
    }
    ...
    {
        $item = QuestionBankBoard::findOrFail($id);
    ...
    {
        return [
            static::MESSAGE_ITEM_DOES_NOT_EXIST_MESSAGE => 'QuestionBankBoard does not exist.',
            static::MESSAGE_ITEM_COULD_NOT_BE_DELETED => 'QuestionBankBoard could not be deleted.',
        ];
    }
}
