...
namespace Modules\Teacher\Services\Gamification;
...
final class GamificationService implements BaseInterface
{
    public function __construct(
        protected Gamification $model
    ) {}
    ...
    public function getById(int $id): ?Gamification
    {
    ...
    public function create(array $data): Gamification
    {
    ...
    public function update(int $id, array $data): ?Gamification
    {
