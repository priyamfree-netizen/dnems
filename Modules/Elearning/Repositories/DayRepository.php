...
use Modules\Elearning\Models\Day;
use Symfony\Component\HttpFoundation\Response;

class DayRepository extends EntityRepository
{
    public string $table = Day::TABLE_NAME;
    ...
    private function getDayQuery(): Builder
    {
    ...
    {
        return [
            static::MESSAGE_ITEM_DOES_NOT_EXIST_MESSAGE => 'Day does not exist.',
            static::MESSAGE_ITEM_COULD_NOT_BE_DELETED => 'Day could not be deleted.',
        ];
    }
}
