...
{
    public string $table = Content::TABLE_NAME;
    ...
    private function getContentQuery(): Builder
    {
    ...
    public function getAll(array $filterData = []): Paginator
    {
        ...
        $query = $this->getContentQuery()->select('*');
    ...
    {
        return [
            static::MESSAGE_ITEM_DOES_NOT_EXIST_MESSAGE => 'Content does not exist.',
            static::MESSAGE_ITEM_COULD_NOT_BE_DELETED => 'Content could not be deleted.',
        ];
    }
}
